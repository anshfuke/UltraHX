...
print
print
print ""+N+"       =[ "+O+"UltraHX v.2 by Deray...Cloned By Kartik Fuke For Ease use...."+N+"                        ]"
print "+ -- --=[ 14 Exploits - 10 Scanners 16 post - 38 virus   ]"
print "+ -- --=[ Blog http://zumizec-com.waper.co/ "+N+"             ]"
print "+ -- --=[ Report Bug On Instagram "+R+"@__mr.superuser__   "+N+"      ]"
print
def help():
		print ""+N+""
		...
		print "UltraHX update      update UltraHX"
		print
		main()
def main():
	dr = raw_input("UlhX > ")
	if dr == "show options":
		...
		help()
		main()
	elif dr == "UltraHX update":
		print ""+B+"~ "+N+"Updating..."
		time.sleep(3)
		print
		print ""+G+" UltraHX WAS UPGRADED!"
		time.sleep(1)
		print
		print ""+N+"cloning newly updated..."
		time.sleep(5)
		os.system("cd ..;rm -rf UltraHX;git clone https://github.com/anshfuke/UltraHX;cd UltraHX;python2 ulhx.py")
		main()
		...
		print "set target"
		target = raw_input(""+N+"UlhX > use exploit("+R+"power_dos"+N+"): ")
		print "target =>"+R+"",target
		run = raw_input(""+N+"UlhX > ")
		if run == "run":
		...
		print "set target"
		list = raw_input(""+N+"UlhX > ("+R+"php_thumb_shell_upload"+N+"): ")
		time.sleep(1)
		print "target =>"+R+"",list
		go = raw_input(""+N+"UlhX > ")
		if go == "run":
		...
		print "set target"
		vc = raw_input(""+N+"UlhX > ("+R+"cpanel_bruteforce"+N+"): ")
		time.sleep(1)
		print "target => "+R+"",vc
		...
		print "set target"
		t = raw_input(""+N+"UlhX > ("+R+"joomla_com_hdflayer"+N+"): ")
		time.sleep(1)
		print "target => "+R+"",t
		...
		print "set target"
		vc = raw_input(""+N+"UlhX > ("+R+"wp_symposium_shell_upload"+N+"): ")
		time.sleep(1)
		print "target => "+R+"",vc
		...
		print "set target"
		er = raw_input(""+N+"UlhX > ("+R+"jm_auto_change_pswd"+N+"): ")
		time.sleep(1)
		print "target =>"+R+"",er
		...
		ft = raw_input(""+N+"UlhX > ("+R+"joomla0day_com_myngallery"+N+"): ")
		print "target =>"+R+"",ft
		gr = raw_input(""+N+"UlhX > ")
		if gr == "run":
			time.sleep(1)
		...
		tops = raw_input(""+N+"UlhX > "+R+"("+N+"cms_war"+R+")"+N+": ")
		print "=>"+R+"" ,tops
		print ""+N+">"+R+" scan "+N+"[dir,shell,backup,files,admin] ?"
		ray = raw_input(""+N+"UlhX > ")
		gay = raw_input(""+N+"UlhX > ")
		if gay == "run":
			print ""+B+"[*]"+N+" Starting attacks..."
		...
		print ""+N+"=> "+R+"set target"
		wop = raw_input(""+N+"UlhX > "+R+"("+N+"wordpress_user_scanners"+R+")"+N+": ")
		print "=> "+R+"enter numbers of users to enumerate."
		enum = raw_input(""+N+"UlhX > ")
		uiop = raw_input("UlhX > ")
		if uiop == "run":
			print ""+B+"[*]"+N+" Starting attacks..."
		...
		print ""+R+"=> "+N+"set target"
		ym = raw_input(""+N+"UlhX > "+R+"("+N+"dir_search"+R+")"+N+":"+N+" ")
		print "target => "+R+"",ym
		time.sleep(2)
		...
		q = raw_input("UlhX > ("+R+"joomla_sqli_scanners"+N+"): ")
		print "list web => "+R+"",q
		m = raw_input(""+N+"UlhX > ")
		if m == "run":
			time.sleep(2)
		...
		print "set target"
		ops = raw_input(""+N+"UlhX > ("+R+"jomscan_v4"+N+"): ")
		print "target => "+R+"",ops
		rup = raw_input(""+N+"UlhX > ")
		if rup == "run":
			print ""+B+"[*]"+N+" Starting Attacks..."
		...
		print "set target"
		x = raw_input("UlhX > ("+R+"joomla_scanners_v3"+N+"): ")
		print "target => "+R+"",x
		i = raw_input(""+N+"UlhX > ")
		if i == "run":
			time.sleep(2)
		...
		print "set target"
		p = raw_input("UlhX > ("+R+"joomla_scanners_v.2"+N+"): ")
		print "target => "+R+"",p
		o = raw_input(""+N+"UlhX > ")
		if o == "run":
		...
		k = raw_input(""+N+"UlhX > ("+R+"joomla_vulnerability_scanners"+N+"): ")
		if k == "run":
			time.sleep(2)
			print ""+B+"[*]"+N+" Starting attacks..."
		...
		print "set list"
		li = raw_input(""+N+"UlhX > ("+R+"jdownloads_scanners"+N+"): ")
		time.sleep(1)
		print "list => "+R+"",li
		ruu = raw_input(""+N+"UlhXloit > ")
		time.sleep(1)
		if ruu == "run":
			print ""+B+"[*] "+N+"Starting attacks..."
